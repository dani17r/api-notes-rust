...
impl Category {
    ...
    pub fn get_fields_string() -> Fields {
        Fields {
            db: DbFields {
                all: "categories.id, categories.title, categories.description"
                    .to_string(),
                without_id: "categories.title, categories.description".to_string(),
                // without_ship: "".to_string(),
                without_id_ship: "".to_string(),
            },
            // normal: (
            //     "id, title, description".to_string(),
            //     "title, description".to_string(),
            //     "".to_string(),
            // ),
            searchs: "title, description".to_string(),
